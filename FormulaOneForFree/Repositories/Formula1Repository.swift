...
public class FormulaOneRepository {
    ...
    public func GetCircuitImage(circuit:String) async -> UIImage? {
        var name = circuit.replacingOccurrences(of: " ", with: "_")
        var ville = ""
        ...
        let url = "https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/2018-redesign-assets/Circuit%20maps%2016x9/\(name)_Circuit\(ville)"
